    ...
    <div
      class="relative overflow-hidden rounded-xl border border-slate-700/60 bg-slate-900/60 p-5 backdrop-blur-xl transition hover:border-cyan-500/40">
        ...
        <div class="flex items-center justify-between">
            <p class="text-xs font-medium tracking-wide text-slate-400 uppercase">{{ kpi.label }}</p>
        ...
        <p v-if="kpi.trend !== null && kpi.trend !== undefined" :class="['mt-1 flex items-center gap-1 text-xs font-medium', trendClass]">
