...
import { create, edit } from '@/routes/customers';
            ...
            <tr v-for="customer in customers" :key="customer.id" class="border-b border-slate-200 dark:border-slate-700">
                ...
                <td class="px-3 py-2">
                    <span
                        ...
                        :class="customer.is_active ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300' : 'bg-slate-200 text-slate-600 dark:bg-slate-700 dark:text-slate-300'"
                    >
