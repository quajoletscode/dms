...
import CustomerDriverVehicleProfiles, {
    type DriverVehicleProfile,
} from '@/components/CustomerDriverVehicleProfiles.vue';
...
const blankDriverVehicleProfile = (): DriverVehicleProfile => ({
    driver_name: '',
    driver_phone: '',
    vehicle_no: '',
    vehicle_description: '',
...
const form = useForm({
    ...
    driver_vehicle_profiles:
        props.customer.driver_vehicle_profiles.length > 0
            ? props.customer.driver_vehicle_profiles
            : [blankDriverVehicleProfile()],
...
<template>
    <div class="max-w-xl space-y-6 py-4">
        ...
        <form
            class="space-y-4 rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800"
        ...
        >
            ...
            <TextInput
                ...
                v-model="form.price_category"
                :error="form.errors.price_category"
                :disabled="form.processing"
            />
            <CustomerDriverVehicleProfiles
                v-model="form.driver_vehicle_profiles"
                :errors="form.errors"
                :disabled="form.processing"
            />
