...
import ProductLineItemsGrid, {
    type LineItemColumn,
    type LineItemRow,
    type ProductOption,
} from '@/components/ProductLineItemsGrid.vue';
...
const filledItems = computed(() =>
    form.items.filter((row) => row.product_id !== '' && row.qty_ordered !== ''),
);
    ...
    <div class="max-w-4xl space-y-6 py-4">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                Order products from a supplier into a warehouse.
            </p>
        </div>
        ...
        <form class="space-y-6" @submit.prevent="submit">
            ...
            <Card>
                ...
                <p v-if="form.errors.items" class="mt-2 text-sm text-red-500">
                    {{ form.errors.items }}
                </p>
